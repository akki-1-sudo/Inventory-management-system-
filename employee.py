...
class employeeClass:
    def __init__(self,root):
        ...
        txt_salary=Entry(self.root,textvariable=self.var_salary,font=("goudy old style",15),bg="lightyellow").place(x=600,y=270,width=150) 
       ...
       #====EAMPLOYEE DETAILS=======================================================
        ...
        self.EmployeeTable.heading("Email",text="Mail ID")
        
        self.EmployeeTable.heading("gender",text="Gender")
        
        self.EmployeeTable.heading("contact",text="Phone")
        ...
        try:
           if self.var_emp_id.get()=="":
             ...
             if row==None:
                ...
                op=messagebox.askyesno("Congirm","Do you really want to delete?",parent=self.root)
                if op==True:
